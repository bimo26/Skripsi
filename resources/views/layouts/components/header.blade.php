        ...
        @if (Auth::check())
          <div class="header-homepage-desktop">
            <li class="dropdown">
              <a href="#" data-bs-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                ...
                <div class="d-none d-md-block d-lg-inline-block">Halo, {{ ucwords(Auth::user()->name) }}</div>
              </a>
          ...
          <div class="header-homepage-mobile">
            <div class="d-flex align-items-center">
              ...
              <div class="d-md-block d-lg-inline-block my-3 text-dark fw-bold">{{ ucwords(Auth::user()->name) }}</div>
            </div>
            <ul class="list-group">
